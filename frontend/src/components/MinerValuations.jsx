...
const sigStyle = { CHEAP: 'bg-emerald-900/30 text-emerald-400', EXPENSIVE: 'bg-red-900/30 text-red-400', FAIR: 'bg-gray-800 text-gray-400' };
  ...
  return (
    <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-bold text-white">💎 Miner Valuations (EV/lb)</h3>
      ...
      <div className="space-y-2">
        {data.miners.map(m => (
          <div key={m.symbol} className="flex items-center gap-3">
            <span className="font-mono text-sm text-gray-300 w-12">{m.symbol}</span>
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-0.5">
                ...
                <span className="font-mono text-xs text-white font-bold w-16 text-right">${m.ev_per_lb}</span>
